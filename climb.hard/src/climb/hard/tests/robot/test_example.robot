...
#
#  $ bin/test -s climb.hard -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src climb.hard.testing.CLIMB_HARD_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/climb/hard/tests/robot/test_example.robot
#
